            ...
            <div class="navbar-header">
				...
				<ul class="nav pull-right">
				  <li style="padding-top:5px;" id="menuLogin">
					<a href="<?php echo base_url();?>index.php/main/logout" id="navLogin" style= "color: white;">Logout</a>
					<div class="dropdown-menu" style="padding:17px;">
						<button type="button" id="btnLogin" class="btn">Logout</button>
					  </form>
					</div>
				  </li>
				</ul>
                    ...
                    <li>
                        <div class="dropdown">
						  ...
						  <ul class="dropdown-menu">
							...
							<li><a href="<?php echo base_url();?>index.php/main/kent">Kent Jimison</a></li>
