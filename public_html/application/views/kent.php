<?php include "header.php"; ?>
	...
	<div class="content-section-a" style = "background-color: black">
        ...
        <div class="container" style="width: 100%; height: 50%;">
            ...
            <img class="center-block" src="<?php echo base_url();?>assets/img/artistBioPictures/kentBioImage.png"  style = "height: 25%; width: 25%; " >
        </div>
        <div class = "container" style="width: 100%; height: 50%;">
        	<h1 style="color: white; text-align: center;">Kent</h1>
        </div>
    </div>
        ...
        <div class="galcontainer" id="imageSlider">
				<div class="galrow">
				  	<?php
				  		$base = base_url();
				  		$count = 1;
						if ($handle = opendir('img/KentsGallery')) {
							...
							{
							echo '<div class = "galcolumn"><img src = "'.base_url().'img/KentsGallery/'.$image.'"onclick = " openModal();currentSlide('.$count.')" class = "hover-shadow"></div> ';
							$count++;
							}
							closedir($handle);
						}
				  ...
				  <div class="modal-content">
					<?php
						...
						if ($handle = opendir('img/KentsGallery')) {
							...
							foreach($images as $image)
							{
							echo '<div class = "mySlides" style = " background-color: black"><img src = "'.base_url().'img/KentsGallery/'.$image.'" style = "width: 50%;"></div> ';
							}
							closedir($handle);
						}
					?>
...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3 well">
            ...
            <input class="form-control" name="to"  type="hidden" value = "kentjimisonink@gmail.com" />
            </fieldset>
            <?php echo form_close(); ?>
